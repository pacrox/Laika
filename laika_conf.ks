...
FUNCTION installLaikaCore {   // {{{
	...
	safeCompileTo("0:/lib/laikalib/", "laika_core.ks", LK_CONF["MAIN_DISK"], d).
	PRINT " " +ENDL +"[Installing Laika Lib-GUI]".
	safeCompileTo("0:/lib/laikalib/", "lib_lk_gui.ks", LK_CONF["MAIN_DISK"], ":/lib/").
...
FUNCTION installMod {
	...
	safeCompileTo("0:/lib/laikalib/mod/", m[0],  LK_CONF["MODS_DISK"], ":/mod/").
	SET PP TO LEXICON().
}
...
FUNCTION installModOLD {
	...
	safeCompileTo("0:/lib/laikalib/mod/", f,  LK_CONF["MODS_DISK"], ":/mod/").
	SET PP TO LEXICON().
}
